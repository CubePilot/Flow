...
void boardInit(void) {
    ...
    // outputs
    palSetLineMode(BOARD_PAL_LINE_FLOW_NRST, PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
    palSetLine(BOARD_PAL_LINE_FLOW_NRST);
    ...
    palSetLine(BOARD_PAL_LINE_SPI_CS_FLOW);
    ...
    palSetLineMode(BOARD_PAL_LINE_AMBER_LED, PAL_STM32_MODE_INPUT);
//     palSetLine(BOARD_PAL_LINE_AMBER_LED);
